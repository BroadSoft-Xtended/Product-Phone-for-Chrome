...
ucone.config(function($stateProvider, $urlRouterProvider, $compileProvider) {
    ...
    ucone.factory("Media", [ "$rootScope", "Storage", "$state", function($rootScope, Storage, $state) {
        ...
        return service.startVideoCall = function(contact) {
            return $rootScope.registeredWRS ? (Storage.setValue("currentCallContact", contact), 
            void $state.go("app.videoCall", {
                contact: contact,
                makeCall: !0,
                displayVideo: !0
            })) : "error";
    ...
    ucone.factory("webRTC", [ "$q", "Storage", "$rootScope", "$state", "Utility", "Auth", function($q, Storage, $rootScope, $state, Utility, Auth) {
        ...
        return service.stop = function() {
            ...
            console.log("broadcasting..."), service.call1.progress = !1, service.call2.progress = !1, 
            ...
            console.log("call1", service.call1), console.log("call2", service.call2), null == service.call1.session && null !== service.call2.session && (service.unhold(service.call2.session), 
            service.call1.active = !1, service.call2.active = !0), null == service.call2.session && null !== service.call1.session && (service.unhold(service.call1.session), 
            service.call1.active = !0, service.call2.active = !1), null == service.call1.session && null == service.call2.session && (console.log("both sessions are null"), 
            service.call1 = {
                session: null,
                active: !1
            }, service.call2 = {
